...
_lightCullingPipelineState = [_device newRenderPipelineStateWithTileDescriptor:tileDescriptor
...
```swift
[encoder setRenderPipelineState:_lightCullingPipelineState];
...
[encoder setTileBuffer:_uniformBuffers[_currentBufferIndex] offset:0 atIndex:AAPLBufferIndexUniforms];
[encoder setTileBuffer:_lightEyePositions[_currentBufferIndex] offset:0 atIndex:AAPLBufferIndexLightsPosition];
