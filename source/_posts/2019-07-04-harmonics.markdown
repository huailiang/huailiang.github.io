...
$$  
Y_1^{-1} = p_y = \sqrt{\frac{3}{4 \pi}} \cdot \frac{y}{r}\ \tag{m =-1}
$$
...
$$  
Y_1^1 = p_x = \sqrt{\frac{3}{4 \pi}} \cdot \frac{x}{r}\ \tag{m = 1}
$$
...
$$  
Y_2^{-2} =d_{xy} = \frac{1}{2} \sqrt{\frac{15}{\pi}} \cdot \frac{x y}{r^2}\ \tag{m =-2}
$$

$$  
Y_2^{-1} = d_{yz} = \frac{1}{2} \sqrt{\frac{15}{\pi}} \cdot \frac{y z}{r^2}\ \tag{m =-1}
$$
...
$$  
Y_2^1 = d_{xz} = \frac{1}{2} \sqrt{\frac{15}{\pi}} \cdot \frac{z x}{r^2}\ \tag{m = 1}
$$

$$  
Y_2^2 = d_{x^2-y^2} =  \frac{1}{4} \sqrt{\frac{15}{\pi}} \cdot \frac{x^2 - y^2 }{r^2}\ \tag{m = 2}
$$
