...
<td>Initiates peer discovery</td></tr>
<tr>
...
<thead>
<tr>
  <th width="48%">Intent </th>
  <th>Description</th>
</tr>
</thead>
<tbody>
<tr>
    <td align="center">WIFI_P2P_CONNECTION_CHANGED_ACTION</td>
    <td>Broadcast when the state of the device's Wi-Fi connection changes.</td>
</tr>
<tr>
    <td align="center">WIFI_P2P_PEERS_CHANGED_ACTION</td>
    <td>Broadcast when you calldiscoverPeers(). You usually want to call requestPeers() to get an updated list of peers if you handle this intent in your application.</td>
</tr>
<tr>
    <td align="center">WIFI_P2P_STATE_CHANGED_ACTION</td>
    <td>Broadcast when Wi-Fi Direct is enabled or disabled on the device.</td>
</tr>
<tr>
    <td align="center">WIFI_P2P_THIS_DEVICE_CHANGED_ACTION</td>
