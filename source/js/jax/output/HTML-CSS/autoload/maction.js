MathJax.Hub.Register.StartupHook("HTML-CSS Jax Ready", function () {
  ...
  MML.maction.Augment({
    ...
    HTMLhandleHitBox: function (span, postfix) {
      ...
      if (HTMLCSS.msieHitBoxBug) {
        ...
        span.insertBefore(box, span.firstChild);
        ...
        span.insertBefore(frame, span.firstChild); 
    ...
    HTMLsetStatus: function (event) {
      window.status=((this.data[1] && this.data[1].isToken)?this.data[1].data.join("") : this.data[1].toString());
    },
  ...
  MathJax.Hub.Browser.Select({
    MSIE: function (browser) {HTMLCSS.msieHitBoxBug = true;}
  });
