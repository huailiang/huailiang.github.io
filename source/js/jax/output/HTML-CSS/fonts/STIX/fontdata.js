...
(function (HTMLCSS,HTML) {
  ...
  HTMLCSS.Augment({
    FONTDATA: {
      ...
      DELIMITERS: {
        ...
        0x002D: {alias: 0x23AF, dir:H}, 
        0x005E: {alias: 0x02D6, dir:H}, 
        0x005F: {alias: 0x23AF, dir:H}, 
        0x007E: {alias: 0x02DC, dir:H}, 
        0x00AF: {alias: 0x23AF, dir:H}, 
        0x02C9: {alias: 0x23AF, dir:H}, 
        0x0302: {alias: 0x02C6, dir:H}, 
        0x0303: {alias: 0x02DC, dir:H}, 
        0x030C: {alias: 0x02C7, dir:H}, 
        0x0332: {alias: 0x23AF, dir:H}, 
  ...
  HTMLCSS.FONTDATA.FONTS['STIXSizeFiveSym'] = {
    ...
    0x20: [0,0,250,0,0],               
    0x5F: [-127,177,3000,0,3000],      
    0xA0: [0,0,250,0,0],               
    0x302: [816,-572,0,-2485,-157],    
    0x303: [780,-617,0,-2485,-157],    
  ...
  HTMLCSS.FONTDATA.FONTS['STIXGeneral'][0x22EE][0] += 400;  
  HTMLCSS.FONTDATA.FONTS['STIXGeneral'][0x22F1][0] += 500;  
  HTMLCSS.FONTDATA.FONTS['STIXGeneral'][0x2212][1] += 100;  
  HTMLCSS.FONTDATA.FONTS['STIXGeneral'][0x003D][1] += 100;  
  HTMLCSS.FONTDATA.FONTS['STIXNonUnicode'][0xE14A][0] += 200;  
  HTMLCSS.FONTDATA.FONTS['STIXNonUnicode'][0xE14A][1] += 200;  
  HTMLCSS.FONTDATA.FONTS['STIXNonUnicode'][0xE14B][0] += 200;  
  HTMLCSS.FONTDATA.FONTS['STIXNonUnicode'][0xE14B][1] += 200;  
  MathJax.Hub.Browser.Select({
    MSIE: function (browser) {
      if (!browser.versionAtLeast("8.0") || document.documentMode < 8) {
        var FONTDATA = HTMLCSS.FONTDATA;
        FONTDATA.REMAP[0x2C9] = 0xAF; 
        FONTDATA.REMAP[0x2CA] = 0xB4; 
        FONTDATA.REMAP[0x2CB] = 0x60; 
        FONTDATA.REMAP[0x2DA] = 0xB0; 
